...
class Executor {
    template <typename F>
    void execute_R_inst (F func);

    template <typename F>
    void execute_I_inst (F func);

    template <typename F>
    void execute_S_inst (F func);

    template <typename F>
    void execute_B_inst (F func);

    template <typename F>
    void execute_U_inst (F func);

    template <typename F>
    void execute_J_inst (F func);
};
